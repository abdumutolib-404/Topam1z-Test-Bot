...
_T: dict[str, dict[str, str]] = {
    ...
    "welcome": {
        "en": (
            ...
            "🎬 Movies & series via MovieBox\n"
            "🎵 Extract MP3 from any video\n"
            "🔍 Identify any song\n"
            "✂️ Edit: trim · compress · convert · merge · speed · reverse\n"
            "📡 Inline mode: type @topam1z_bot in any chat\n\n"
            "📢 {channel}"
        ),
        "ru": (
            "👋 Привет, <b>{name}</b>!\n"
            "Добро пожаловать в <b>@topam1z_bot</b>\n\n"
            "⬇️ Скачать из YouTube, Instagram, TikTok, Twitter и других\n"
            "🎬 Фильмы и сериалы через MovieBox\n"
            "🎵 Извлечь MP3 из любого видео\n"
            "🔍 Определить любую песню\n"
            "✂️ Редактировать: обрезать · сжать · конвертировать · склеить · скорость\n"
            "📡 Инлайн: напиши @topam1z_bot в любом чате\n\n"
            "📢 {channel}"
        ),
        "uz": (
            "👋 Salom, <b>{name}</b>!\n"
            ...
            "🎬 Kino va seriallar — MovieBox orqali\n"
            "🎵 Har qanday videodan MP3 ajratish\n"
            "🔍 Istalgan qo'shiqni aniqlash\n"
            "✂️ Tahrirlash: kesish · siqish · format · birlashtirish · tezlik\n"
            "📡 Inline: istalgan chatda @topam1z_bot deb yozing\n\n"
            "📢 {channel}"
        ),
    },
